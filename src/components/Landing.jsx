...
const Landing = () => {
  return (
    <header id='home' className='lg:h-screen  flex items-center flex-col md:flex-row pt-28 md:pt-0 justify-between bg-primarypurple/20 md:px-11 p-5   lg:pt-0 md:gap-10 '>
